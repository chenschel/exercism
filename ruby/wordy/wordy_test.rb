...
class WordyTest < Minitest::Test
  ...
  def test_power_2
    # skip
    problem = WordProblem.new("What is 2 raised to the 2nd power?")
    assert_equal(4, problem.answer)
  end

  def test_power_1
    # skip
    problem = WordProblem.new("What is 2 raised to the 1st power?")
    assert_equal(2, problem.answer)
  end

  def test_power_3
    # skip
    problem = WordProblem.new("What is 2 raised to the 3rd power?")
    assert_equal(8, problem.answer)
  end
end
